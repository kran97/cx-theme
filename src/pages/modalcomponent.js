...
// import page13image2 from "../app/assets/images/page13image2.png"
...
//                             <h4>Your doctor appointment is confirmed.</h4>
//                         </BlocxModalHeader.Default>
//                         <BlocxModalBody.Default className="row-md-9">
//                             <p>A confirmation email and reminder sent to your contacts. detracto, vidit vituperatoribus duo id. Afert dtraxis voluptatatum vis eu innermis eloquntium cum id. Mei aequeue.</p>
//                             <BlocxModalButtonControls.Default >
//                                 <BlocxButton.Secondary_Outline className="dialogboxbutton" label="Reschedule" onClick={this.onRescheduleButtonClick.bind(this)} >
